# Using CI Pacific Portal to Access Advanced Computing Resources and AI Workflows
...
| 10:30-10:45 AM | 15 min | Coffee Break |
| 10:45-11:30 AM | 45 min | (Lecture) [Classes of AI Models, 3rd Party Model Registries, Flexserv](./Tapis_FlexServ/01-lecture.md) |
| 11:30-12:00 PM | 30 min | (Hands-on) [Executing Large Models on Vista Via Tapis and Flexserv](./Tapis_FlexServ/01b-running-flexserv.md) |
| 12:00-1:00 PM  | 60 min | Lunch  |
| 1:00-2:00 PM | 30 min | (Lecture) [Computer Vision Models in Scientific Applications](./Vision_Models/01-intro-vision-models.md) |
...
## Links & Documentation
[The tutorial covers TapisUI in the public tenant: cipp.tapis.io](https://cipp.tapis.io)

[![TapisUI Dashboard](/tutorials/assets/tapisui_home.png){:style="max-width:50%;"}](https://cipp.tapis.io){:target="_blank"}
